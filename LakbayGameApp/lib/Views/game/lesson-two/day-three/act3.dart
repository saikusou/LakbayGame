...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: LessonTwoDayThreeActThree(
...
class LessonTwoDayThreeActThree extends StatefulWidget {
  final UserModel user;

  const LessonTwoDayThreeActThree({super.key, required this.user});

  @override
  State<LessonTwoDayThreeActThree> createState() =>
      _LessonTwoDayThreeActThreeState();
}

class _LessonTwoDayThreeActThreeState extends State<LessonTwoDayThreeActThree> {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Positioned.fill(
            child: Image.asset(
              'assets/lesson-two-day3-act3a.png',
              fit: BoxFit.fill,
            ),
          ),
