...
class LessonTwoDayTwoActFive extends StatefulWidget {
  final UserModel user;

  const LessonTwoDayTwoActFive({super.key, required this.user});

  @override
  State<LessonTwoDayTwoActFive> createState() => _LessonTwoDayTwoActFiveState();
}

class _LessonTwoDayTwoActFiveState extends State<LessonTwoDayTwoActFive> {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Positioned.fill(
            child: Image.asset(
              'assets/lesson-two-day2-act5t.png',
              fit: BoxFit.fill,
            ),
          ),
