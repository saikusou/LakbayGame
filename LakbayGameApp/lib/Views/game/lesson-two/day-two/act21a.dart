...
class LessonTwoDayTwoActTwoB extends StatefulWidget {
  final UserModel user;

  const LessonTwoDayTwoActTwoB({super.key, required this.user});

  @override
  State<LessonTwoDayTwoActTwoB> createState() => _LessonTwoDayTwoActTwoBState();
}

class _LessonTwoDayTwoActTwoBState extends State<LessonTwoDayTwoActTwoB> {
  ...
  void goToNextPage() {
    ...
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (_) => LessonTwoDayTwoActTwo2(user: widget.user),
      ),
    );
  }
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: Stack(
          fit: StackFit.expand,
          children: [
            Image.asset('assets/konek-latitud.png', fit: BoxFit.fill),
