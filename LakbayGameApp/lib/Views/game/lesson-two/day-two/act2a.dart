...
class _LessonTwoDayTwoActTwoAState extends State<LessonTwoDayTwoActTwoA> {
  ...
  Widget build(BuildContext context) {
    ...
    final nextButtonWidth = clampDouble(screenWidth * 0.50, 180, 260);

    final nextButtonHeight = clampDouble(screenHeight * 0.07, 50, 62);

    final bottomAreaHeight = clampDouble(screenHeight * 0.12, 85, 110);
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Expanded(
              child: Stack(
                ...
                children: [
                  ...
                  // HOME BUTTON
                  Positioned(
                    top: clampDouble(screenHeight * 0.012, 8, 14),
            ...
            // NEXT BUTTON AREA BELOW THE IMAGE
            Container(
              width: double.infinity,
              height: bottomAreaHeight,
              padding: EdgeInsets.symmetric(
                horizontal: 20,
                vertical: clampDouble(screenHeight * 0.018, 12, 18),
              ),
