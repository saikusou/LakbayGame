...
class LessonTwoDayOneActThree extends StatefulWidget {
  ...
  State<LessonTwoDayOneActThree> createState() {
    return _LessonTwoDayOneActThreeState();
  }
}

class _LessonTwoDayOneActThreeState extends State<LessonTwoDayOneActThree> {
  // Complete the activity after 13 different diamonds.
  static const int totalDiamonds = 13;

  // Points saved to the database.
  static const int activityPoints = 100;

  static const double originalImageWidth = 1118;
  static const double originalImageHeight = 1407;
  ...
  final List<String> popupImages = const [
    'assets/lesson-two-day1-act3-pic1.png',
    'assets/lesson-two-day1-act3-pic2.png',
    'assets/lesson-two-day1-act3-pic3.png',
    'assets/lesson-two-day1-act3-pic4.png',
    'assets/lesson-two-day1-act3-pic5.png',
    'assets/lesson-two-day1-act3-pic6.png',
    'assets/lesson-two-day1-act3-pic7.png',
    'assets/lesson-two-day1-act3-pic8.png',
    'assets/lesson-two-day1-act3-pic9.png',
    'assets/lesson-two-day1-act3-pic10.png',
    'assets/lesson-two-day1-act3-pic11.png',
    'assets/lesson-two-day1-act3-pic12.png',
    'assets/lesson-two-day1-act3-pic13.png',
  ];

  final List<DiamondPosition> diamondPositions = const [
    DiamondPosition(id: 1, x: 141, y: 757),
    DiamondPosition(id: 2, x: 357, y: 757),
    DiamondPosition(id: 3, x: 558, y: 757),
    DiamondPosition(id: 4, x: 762, y: 757),
    DiamondPosition(id: 5, x: 974, y: 757),

    DiamondPosition(id: 6, x: 141, y: 951),
    DiamondPosition(id: 7, x: 357, y: 951),
    DiamondPosition(id: 8, x: 558, y: 951),
    DiamondPosition(id: 9, x: 762, y: 951),
    DiamondPosition(id: 10, x: 974, y: 951),

    DiamondPosition(id: 11, x: 141, y: 1134),
    DiamondPosition(id: 12, x: 357, y: 1134),
    DiamondPosition(id: 13, x: 558, y: 1134),
  ];
  ...
  Future<void> handleSavePoints({required int totalScore}) async {
    ...
    try {
      ...
      // Ignore duplicate records and continue to Lesson 2.
      if (isDuplicate) {
        alreadyScored = true;
        return;
      }
  ...
  Future<void> showDiamondPopup({required int id}) async {
    ...
    final bool allDiamondsClicked = clickedDiamonds.length >= totalDiamonds;
  ...
  Widget buildClickableDiamond({
    ...
    const originalClickableWidth = 158.0;
    const originalClickableHeight = 132.0;
        ...
        child: AnimatedContainer(
          ...
          child: alreadyClicked
              ? Icon(
                  Icons.check_rounded,
                  color: Colors.white,
                  size: clampDouble(clickableWidth * 0.35, 22, 42),
                  shadows: const [
                    Shadow(
