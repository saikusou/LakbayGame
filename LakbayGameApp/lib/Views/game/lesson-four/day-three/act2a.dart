...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: LessonFourDayThreeActTwoA(
...
class LessonFourDayThreeActTwoA extends StatefulWidget {
  final UserModel user;

  const LessonFourDayThreeActTwoA({super.key, required this.user});

  @override
  State<LessonFourDayThreeActTwoA> createState() =>
      _LessonFourDayThreeActTwoAState();
}

class _LessonFourDayThreeActTwoAState extends State<LessonFourDayThreeActTwoA> {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Positioned.fill(
            child: Image.asset(
              'assets/lesson-four-day3-act2a.jpg',
              fit: BoxFit.fill,
            ),
          ),
