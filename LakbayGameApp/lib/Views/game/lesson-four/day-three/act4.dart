...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: LessonFourDayThreeActFour(
...
class LessonFourDayThreeActFour extends StatefulWidget {
  final UserModel user;

  const LessonFourDayThreeActFour({super.key, required this.user});

  @override
  State<LessonFourDayThreeActFour> createState() =>
      _LessonFourDayThreeActFourState();
}

class _LessonFourDayThreeActFourState extends State<LessonFourDayThreeActFour> {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Positioned.fill(
            child: Image.asset(
              'assets/lesson-four-day3-act4.png',
              fit: BoxFit.fill,
            ),
          ),
