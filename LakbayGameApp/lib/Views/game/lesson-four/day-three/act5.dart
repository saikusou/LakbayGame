...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: LessonFourDayThreeActFive(
...
class LessonFourDayThreeActFive extends StatefulWidget {
  final UserModel user;

  const LessonFourDayThreeActFive({super.key, required this.user});

  @override
  State<LessonFourDayThreeActFive> createState() =>
      _LessonFourDayThreeActFiveState();
}

class _LessonFourDayThreeActFiveState extends State<LessonFourDayThreeActFive> {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Positioned.fill(
            child: Image.asset(
              'assets/lesson-four-day3-act5.png',
              fit: BoxFit.fill,
            ),
          ),
