...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: LessonFourDayOneActThreeA(
...
class LessonFourDayOneActThreeA extends StatefulWidget {
  final UserModel user;

  const LessonFourDayOneActThreeA({super.key, required this.user});

  @override
  State<LessonFourDayOneActThreeA> createState() =>
      _LessonFourDayOneActThreeAState();
}

class _LessonFourDayOneActThreeAState extends State<LessonFourDayOneActThreeA> {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Positioned.fill(
            child: Image.asset(
              'assets/lesson-four-day1-act3a.png',
              fit: BoxFit.fill,
            ),
          ),
