...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: LessonFourDayFourActThree(
...
class LessonFourDayFourActThree extends StatefulWidget {
  final UserModel user;

  const LessonFourDayFourActThree({super.key, required this.user});

  @override
  State<LessonFourDayFourActThree> createState() =>
      _LessonFourDayFourActThreeState();
}

class _LessonFourDayFourActThreeState extends State<LessonFourDayFourActThree> {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Positioned.fill(
            child: Image.asset(
              'assets/lesson-four-day4-act5t.jpg',
              fit: BoxFit.fill,
            ),
          ),
