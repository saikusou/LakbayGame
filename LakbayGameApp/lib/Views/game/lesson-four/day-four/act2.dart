...
class LessonFourDayFourActTwo extends StatefulWidget {
  final UserModel user;

  const LessonFourDayFourActTwo({super.key, required this.user});

  @override
  State<LessonFourDayFourActTwo> createState() =>
      _LessonFourDayFourActTwoState();
}

class _LessonFourDayFourActTwoState extends State<LessonFourDayFourActTwo> {
  int currentImage = 0;

  final List<String> images = [
    'assets/lesson-four-day4-act5.jpg',
    'assets/lesson-four-day4-act5a.jpg',
    'assets/lesson-four-day4-act5b.jpg',
    'assets/lesson-four-day4-act5c.jpg',
  ];
