...
class LessonFourDayOneActTwo extends StatefulWidget {
  final UserModel user;

  const LessonFourDayOneActTwo({super.key, required this.user});

  @override
  State<LessonFourDayOneActTwo> createState() => _LessonFourDayOneActTwoState();
}

class _LessonFourDayOneActTwoState extends State<LessonFourDayOneActTwo> {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Positioned.fill(
            child: Image.asset(
              'assets/lesson-four-day1-act2.png',
              fit: BoxFit.fill,
            ),
          ),
