...
import 'package:lakbay_game/Views/game/lesson-four/act2.dart';
import 'package:lakbay_game/Views/game/lesson-four/act3.dart';
import 'package:lakbay_game/Views/game/lesson-four/act4.dart';
...
class Day1Popup extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (title.contains('Ilarawan')) {
      Future.microtask(() {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => LessonFourDayOneActTwo(user: user)),
        );
      });
    ...
    if (title.contains('Tama o Mali')) {
      Future.microtask(() {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => LessonFourDayOneActFour(user: user),
          ),
        );
      });
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          image: const DecorationImage(
            image: AssetImage('assets/lesson-four-day1-act1.png'),
            fit: BoxFit.fill,
          ),
        ),
    ...
    return Dialog(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          /// BACKGROUND IMAGE
          image: const DecorationImage(
            image: AssetImage('assets/lesson-four-day1-act3.png'),
            fit: BoxFit.fill,
          ),
        ),
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          LessonFourDayOneActThree(user: user),
                    ),
                  );
                },
    ...
    return Dialog(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          /// BACKGROUND IMAGE
          image: const DecorationImage(
            image: AssetImage('assets/lesson-four-day1-act5.jpg'),
            fit: BoxFit.cover,
          ),
        ),
